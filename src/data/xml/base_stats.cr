...
#     doc.find_element("list") do |list|
#       list.each_element do |stat|
#         stat.find_element("stat") do |attrs|
#           value = attrs["value"].to_i
#           bonus = attrs["bonus"].to_f

#           case stat.name.casecmp
#           when "STR"
#             STRStat::BONUS[value] = bonus
#           when "DEX"
#             DEXStat::BONUS[value] = bonus
#           when "CON"
#             CONStat::BONUS[value] = bonus
#           when "INT"
#             INTStat::BONUS[value] = bonus
#           when "WIT"
#             WITStat::BONUS[value] = bonus
#           when "MEN"
#             MENStat::BONUS[value] = bonus
#           else
#             raise "Wrong stat name #{stat.name}"
#           end
#         end
