  ...
  def handle(buffer : ByteBuffer, client : GameClient) : GameClientPacket?
    ...
    when .in_game?
      ...
      when 0x15 # RequestEquipItem
        ...
        # client.handle_cheat("Used obsolote RequestEquipItem packet!")
      ...
      when 0x34 # RequestSocialAction
        ...
        # client.handle_cheat("Used obsolote RequestSocialAction packet!")
      when 0x35 # ChangeMoveType2
        warn "Received obsolete ChangeMoveType packet."
        # client.handle_cheat("Used obsolote ChangeMoveType packet!")
      when 0x36 # ChangeWaitType2
        warn "Received obsolete ChangeWaitType packet."
        # client.handle_cheat("Used obsolote ChangeWaitType packet!")
