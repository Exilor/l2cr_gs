...
module Config
  ...
  class_property warehouse_cache_time : Int64 = 0i64
  ...
  class_property allow_fishing : Bool = false
  ...
  private def load_flood_protector_config(cfg, config, str, default_interval)
    ...
    config.punishment_time = cfg.get_i32("FloodProtector#{str}PunishmentTime") * 60_000
  end
  ...
  def load
    ...
    @@ch_tele_fee_ratio = cfg.get_i64("ClanHallTeleportFunctionFeeRatio", 604_800_000)
    @@ch_tele1_fee = cfg.get_i32("ClanHallTeleportFunctionFeeLvl1", 7000)
    @@ch_tele2_fee = cfg.get_i32("ClanHallTeleportFunctionFeeLvl2", 14_000)
    ...
    @@ch_support4_fee = cfg.get_i32("ClanHallSupportFeeLvl4", 11_000)
    @@ch_support5_fee = cfg.get_i32("ClanHallSupportFeeLvl5", 21_000)
    @@ch_support6_fee = cfg.get_i32("ClanHallSupportFeeLvl6", 36_000)
    @@ch_support7_fee = cfg.get_i32("ClanHallSupportFeeLvl7", 37_000)
    @@ch_support8_fee = cfg.get_i32("ClanHallSupportFeeLvl8", 52_000)
    ...
    @@ch_mpreg4_fee = cfg.get_i32("ClanHallMpRegenerationFeeLvl4", 13_750)
    @@ch_mpreg5_fee = cfg.get_i32("ClanHallMpRegenerationFeeLvl5", 20_000)
    ...
    @@ch_expreg4_fee = cfg.get_i32("ClanHallExpRegenerationFeeLvl4", 15_000)
    @@ch_expreg5_fee = cfg.get_i32("ClanHallExpRegenerationFeeLvl5", 21_000)
    @@ch_expreg6_fee = cfg.get_i32("ClanHallExpRegenerationFeeLvl6", 23_330)
    @@ch_expreg7_fee = cfg.get_i32("ClanHallExpRegenerationFeeLvl7", 30_000)
    @@ch_item_fee_ratio = cfg.get_i64("ClanHallItemCreationFunctionFeeRatio", 86_400_000)
    @@ch_item1_fee = cfg.get_i32("ClanHallItemCreationFunctionFeeLvl1", 30_000)
    @@ch_item2_fee = cfg.get_i32("ClanHallItemCreationFunctionFeeLvl2", 70_000)
    @@ch_item3_fee = cfg.get_i32("ClanHallItemCreationFunctionFeeLvl3", 140_000)
    @@ch_curtain_fee_ratio = cfg.get_i64("ClanHallCurtainFunctionFeeRatio", 604_800_000)
    ...
    @@ch_front_fee_ratio = cfg.get_i64("ClanHallFrontPlatformFunctionFeeRatio", 259_200_000)
    ...
    @@cs_tele_fee_ratio = cfg.get_i64("CastleTeleportFunctionFeeRatio", 604_800_000)
    @@cs_tele1_fee = cfg.get_i32("CastleTeleportFunctionFeeLvl1", 1000)
    @@cs_tele2_fee = cfg.get_i32("CastleTeleportFunctionFeeLvl2", 10_000)
    @@cs_support_fee_ratio = cfg.get_i64("CastleSupportFunctionFeeRatio", 604_800_000)
    @@cs_support1_fee = cfg.get_i32("CastleSupportFeeLvl1", 49_000)
    @@cs_support2_fee = cfg.get_i32("CastleSupportFeeLvl2", 120_000)
    @@cs_mpreg_fee_ratio = cfg.get_i64("CastleMpRegenerationFunctionFeeRatio", 604_800_000)
    @@cs_mpreg1_fee = cfg.get_i32("CastleMpRegenerationFeeLvl1", 45_000)
    @@cs_mpreg2_fee = cfg.get_i32("CastleMpRegenerationFeeLvl2", 65_000)
    @@cs_hpreg_fee_ratio = cfg.get_i64("CastleHpRegenerationFunctionFeeRatio", 604_800_000)
    @@cs_hpreg1_fee = cfg.get_i32("CastleHpRegenerationFeeLvl1", 12_000)
    @@cs_hpreg2_fee = cfg.get_i32("CastleHpRegenerationFeeLvl2", 20_000)
    @@cs_expreg_fee_ratio = cfg.get_i64("CastleExpRegenerationFunctionFeeRatio", 604_800_000)
    @@cs_expreg1_fee = cfg.get_i32("CastleExpRegenerationFeeLvl1", 63_000)
    @@cs_expreg2_fee = cfg.get_i32("CastleExpRegenerationFeeLvl2", 70_000)

    @@outer_door_upgrade_price2 = cfg.get_i32("OuterDoorUpgradePriceLvl2", 3_000_000)
    @@outer_door_upgrade_price3 = cfg.get_i32("OuterDoorUpgradePriceLvl3", 4_000_000)
    @@outer_door_upgrade_price5 = cfg.get_i32("OuterDoorUpgradePriceLvl5", 5_000_000)
    @@inner_door_upgrade_price2 = cfg.get_i32("InnerDoorUpgradePriceLvl2", 750_000)
    @@inner_door_upgrade_price3 = cfg.get_i32("InnerDoorUpgradePriceLvl3", 900_000)
    @@inner_door_upgrade_price5 = cfg.get_i32("InnerDoorUpgradePriceLvl5", 1_000_000)
    @@wall_upgrade_price2 = cfg.get_i32("WallUpgradePriceLvl2", 1_600_000)
    @@wall_upgrade_price3 = cfg.get_i32("WallUpgradePriceLvl3", 1_800_000)
    @@wall_upgrade_price5 = cfg.get_i32("WallUpgradePriceLvl5", 2_000_000)
    @@trap_upgrade_price1 = cfg.get_i32("TrapUpgradePriceLvl1", 3_000_000)
    @@trap_upgrade_price2 = cfg.get_i32("TrapUpgradePriceLvl2", 4_000_000)
    @@trap_upgrade_price3 = cfg.get_i32("TrapUpgradePriceLvl3", 5_000_000)
    @@trap_upgrade_price4 = cfg.get_i32("TrapUpgradePriceLvl4", 6_000_000)

    @@fs_tele_fee_ratio = cfg.get_i64("FortressTeleportFunctionFeeRatio", 604_800_000)
    ...
    @@fs_expreg2_fee = cfg.get_i32("FortressExpRegenerationFeeLvl2", 10_000)
    ...
    @@alt_maximum_player_contrib = cfg.get_i64("AltMaxPlayerContrib", 1_000_000)
    @@alt_festival_manager_start = cfg.get_i64("AltFestivalManagerStart", 120_000)
    @@alt_festival_length = cfg.get_i64("AltFestivalLength", 1_080_000)
    @@alt_festival_cycle_length = cfg.get_i64("AltFestivalCycleLength", 2_280_000)
    @@alt_festival_first_spawn = cfg.get_i64("AltFestivalFirstSpawn", 120_000)
    @@alt_festival_first_swarm = cfg.get_i64("AltFestivalFirstSwarm", 300_000)
    @@alt_festival_second_spawn = cfg.get_i64("AltFestivalSecondSpawn", 540_000)
    @@alt_festival_second_swarm = cfg.get_i64("AltFestivalSecondSwarm", 720_000)
    @@alt_festival_chest_spawn = cfg.get_i64("AltFestivalChestSpawn", 900_000)
    ...
    @@ssq_join_dawn_adena_fee = cfg.get_i32("SevenSignsJoinDawnFee", 50_000)
    ...
    @@knight_unit_cost = cfg.get_i32("CreateKnightUnitCost", 10_000)
    ...
    @@clan_level_7_cost = cfg.get_i32("ClanLevel7Cost", 10_000)
    @@clan_level_8_cost = cfg.get_i32("ClanLevel8Cost", 20_000)
    @@clan_level_9_cost = cfg.get_i32("ClanLevel9Cost", 40_000)
    @@clan_level_10_cost = cfg.get_i32("ClanLevel10Cost", 40_000)
    @@clan_level_11_cost = cfg.get_i32("ClanLevel11Cost", 75_000)
    ...
    @@fee_delete_transfer_skills = cfg.get_i64("FeeDeleteTransferSkills", 10_000_000_i64)
    @@fee_delete_subclass_skills = cfg.get_i64("FeeDeleteSubClassSkills", 10_000_000_i64)
    ...
    @@max_personal_fame_points = cfg.get_i32("MaxPersonalFamePoints", 100_000)
    ...
    @@max_adena = cfg.get_i64("MaxAdena", 99_900_000_000) rescue Int64::MAX
    ...
    @@connection_close_time = cfg.get_i64("ConnectionCloseTime", 60_000)
    ...
    @@save_dropped_item_interval = cfg.get_i32("SaveDroppedItemInterval", 60) * 60_000
    ...
    @@warehouse_cache_time = cfg.get_i64("WarehouseCacheTime", 15)
    ...
    @@allow_fishing = cfg.get_bool("AllowFishing", true)
    @@allow_manor = cfg.get_bool("AllowManor", true)
    @@allow_boat = cfg.get_bool("AllowBoat", true)
    @@boat_broadcast_radius = cfg.get_i32("BoatBroadcastRadius", 20_000)
    ...
    @@alt_lottery_prize = cfg.get_i64("AltLotteryPrize", 50_000)
    ...
    @@raid_minion_respawn_timer = cfg.get_f64("RaidMinionRespawnTime", 300_000)
    ...
    @@wedding_teleport_price = cfg.get_i32("WeddingTeleportPrice", 50_000)
    ...
    @@alt_oly_cperiod = cfg.get_i64("AltOlyCPeriod", 21_600_000)
    @@alt_oly_battle = cfg.get_i64("AltOlyBattle", 300_000)
    @@alt_oly_wperiod = cfg.get_i64("AltOlyWPeriod", 604_800_000)
