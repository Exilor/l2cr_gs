...
#         if pos = pc.acting_player.current_skill_world_position
#           x, y, z = pos.xyz
#         end
#       end
...
#       ep.summoner = pc
#       ep.spawn_me(x, y, z)
#       @despawn_delay = NpcData[@npc_id].parameters.get_i32("despawn_time") * 1000
#       if @despawn_delay > 0
#         ep.schedule_despawn(@despawn_delay.to_i64)
#       end
#     else
#       spwn = L2Spawn.new(@npc_id)
#       x, y = pc.x, pc.y
#       if @random_offset
...
#       spwn.x, spwn.y, spwn.z = x, y, pc.z
#       spwn.heading = pc.heading
#       spwn.stop_respawn

#       npc = spwn.do_spawn(@is_summon_spawn)
#       npc.summoner = pc
