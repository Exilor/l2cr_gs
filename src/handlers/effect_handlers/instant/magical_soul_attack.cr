# class EffectHandler::MagicalSoulAttack < AbstractEffect
#   @power : Float64
...
class EffectHandler::MagicalSoulAttack < EffectHandler::MagicalAttack
  # Handling of damage boost using souls has been moved to MagicalAttack.
end
