class EffectHandler::Reeling < AbstractEffect
  @power : Float64
  ...
  def on_start(info)
    ...
    unless fish = pc.fish_combat
      pc.send_packet(SystemMessageId::CAN_USE_REELING_ONLY_WHILE_FISHING)
      pc.action_failed
      return
    end
