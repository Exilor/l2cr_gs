# class EffectHandler::PhysicalSoulAttack < AbstractEffect
#   @power : Float64
...
class EffectHandler::PhysicalSoulAttack < EffectHandler::PhysicalAttack
  # Handling of damage boost using souls has been moved to PhysicalAttack.
end
