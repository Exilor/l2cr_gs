...
module Formulas
  ...
  def add_funcs_to_new_character(char : L2Character)
    if char.player?
      char.add_stat_func(FuncMaxHpMul::INSTANCE)
      char.add_stat_func(FuncMaxCpMul::INSTANCE)
      char.add_stat_func(FuncMaxMpMul::INSTANCE)
      char.add_stat_func(FuncPAtkMod::INSTANCE)
      char.add_stat_func(FuncMAtkMod::INSTANCE)
      char.add_stat_func(FuncPDefMod::INSTANCE)
      char.add_stat_func(FuncMDefMod::INSTANCE)
      char.add_stat_func(FuncAtkCritical::INSTANCE)
      char.add_stat_func(FuncMAtkCritical::INSTANCE)
      char.add_stat_func(FuncAtkAccuracy::INSTANCE)
      char.add_stat_func(FuncAtkEvasion::INSTANCE)
      char.add_stat_func(FuncPAtkSpeed::INSTANCE)
      char.add_stat_func(FuncMAtkSpeed::INSTANCE)
      char.add_stat_func(FuncMoveSpeed::INSTANCE)

      char.add_stat_func(FuncHenna::STR)
      char.add_stat_func(FuncHenna::DEX)
      char.add_stat_func(FuncHenna::INT)
      char.add_stat_func(FuncHenna::MEN)
      char.add_stat_func(FuncHenna::CON)
      char.add_stat_func(FuncHenna::WIT)

      char.add_stat_func(FuncArmorSet::STR)
      char.add_stat_func(FuncArmorSet::DEX)
      char.add_stat_func(FuncArmorSet::INT)
      char.add_stat_func(FuncArmorSet::MEN)
      char.add_stat_func(FuncArmorSet::CON)
      char.add_stat_func(FuncArmorSet::WIT)
    elsif char.summon?
      char.add_stat_func(FuncMaxHpMul::INSTANCE)
      char.add_stat_func(FuncMaxMpMul::INSTANCE)
      char.add_stat_func(FuncPAtkMod::INSTANCE)
