module Siegable
  ...
  abstract def attacker_clans : Interfaces::Array(L2SiegeClan)?
  abstract def attackers_in_zone : Interfaces::Array(L2PcInstance)
  ...
  abstract def defender_clans : Interfaces::Array(L2SiegeClan)?
  abstract def defender?(clan : L2Clan?) : Bool
  abstract def get_flag(clan : L2Clan?) : Interfaces::Array(L2Npc)?
