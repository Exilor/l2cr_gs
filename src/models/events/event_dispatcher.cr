...
#   def notify(event : BaseEvent, callback_class : (T.class)?) forall T # returns subclass of AbstractEventreturn | nil
#     notify(event, nil, callback_class)
#   end

#   def notify(event : BaseEvent, container : ListenersContainer) # returns subclass of AbstractEventreturn | nil (always nil in this case)
#     notify(event, container, nil)
#   end

#   def notify(event : BaseEvent, container : ListenersContainer?, callback_class : (T.class)?) forall T # returns subclass of AbstractEventreturn | nil
...
#   private def notify_impl(event : BaseEvent, container : ListenersContainer?, callback_class : (T.class)?) forall T # returns subclass of AbstractEventreturn | nil
#     callback = nil
...
#   private def to_listeners(listeners : Enumerable(AbstractEventListener), event : BaseEvent, return_class : (T.class)?, callback : T?) : T? forall T # returns subclass of AbstractEventreturn | nil
