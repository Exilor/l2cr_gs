class TransformTemplate
  ...
  @additional_skills : Array(AdditionalSkillHolder)?
  @additional_items : Array(AdditionalItemHolder)?
  ...
  def add_additional_skill(holder : AdditionalSkillHolder)
    (@additional_skills ||= [] of AdditionalSkillHolder) << holder
  end

  def additional_skills : Indexable(AdditionalSkillHolder)
    @additional_skills || Slice(AdditionalSkillHolder).empty
  end

  def add_additional_item(holder : AdditionalItemHolder)
    (@additional_items ||= [] of AdditionalItemHolder) << holder
  end

  def additional_items : Indexable(AdditionalItemHolder)
    @additional_items || Slice(AdditionalItemHolder).empty
  end
