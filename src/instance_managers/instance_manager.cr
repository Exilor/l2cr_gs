...
module InstanceManager
  ...
  private PLAYER_INSTANCE_TIMES = Concurrent::Map(Int32, Concurrent::Map(Int32, Int64)).new
  ...
  def get_all_instance_times(pc_l2id : Int32) : Concurrent::Map(Int32, Int64)
    unless PLAYER_INSTANCE_TIMES.has_key?(pc_l2id)
      restore_instance_times(pc_l2id)
    end
  ...
  def instances : Concurrent::Map(Int32, Instance)
    INSTANCES
  end
end
