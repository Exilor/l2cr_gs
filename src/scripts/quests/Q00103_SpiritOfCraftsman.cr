class Scripts::Q00103_SpiritOfCraftsman < Quest
  ...
  def initialize
    ...
    add_kill_id(
      MARSH_ZOMBIE, DOOM_SOLDIER, SKELETON_HUNTER, SKELETON_HUNTER_ARCHER
    )
    register_quest_items(
      KARRODS_LETTER, CECKTINONS_VOUCHER1, CECKTINONS_VOUCHER2, SOUL_CATCHER,
      PRESERVE_OIL, ZOMBIE_HEAD, STEELBENDERS_HEAD, BONE_FRAGMENT
    )
  end
