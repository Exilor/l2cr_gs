class Quests::Q00115_TheOtherSideOfTruth < Quest
  # NPCs
  private MISA = 32018
  ...
  def on_talk(npc, player)
    ...
    when State::CREATED
      htmltext = player.level >= MIN_LEVEL ? "32020-01.htm" : "32020-03.html"
    when State::STARTED
      case npc.id
      when RAFFORTY
        case st.cond
        ...
        when 2
          htmltext = !st.has_quest_items?(MISAS_LETTER) ? "32020-05.html" : "32020-06.html"
        when 3
